...
public class GuiButton extends Gui implements FontHook {
     ...
     */
    public void drawButton(Minecraft mc, int mouseX, int mouseY, boolean rectangle) {
        if (this.visible) {
            ...
            Main.fontLoader.boldLittle.drawCenteredString(this.displayString, this.xPosition + this.width / 2, this.yPosition + (this.height - 8) / 2 - 1.5f, -1);
        }
    }
